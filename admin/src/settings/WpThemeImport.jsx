...
import { Upload, FolderOpen, Loader2, CheckCircle2, AlertCircle, ArrowRight, FileCode, X, Type, Zap, Cpu, Globe, Sparkles } from 'lucide-react';
import api from '../lib/api';
import { useTranslation } from '../context/TranslationContext';

export default function WpThemeImport() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">{_('themes.wp_import.page_title', 'Import Theme')}</h1>
      </div>
