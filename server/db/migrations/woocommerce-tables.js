/**
 * WooCommerce Database Tables Migration
 * 
 * Creates WooCommerce-compatible tables that mirror the actual WooCommerce schema.
 * These tables work alongside WolfWave's native tables with a bidirectional sync layer.
 * 
 * This allows third-party integrations (Zapier, ShipStation, etc.) to connect to
 * WolfWave as if it were a WooCommerce site.
 */

export const woocommerceTables = [
  // WooCommerce API Keys (for OAuth authentication)
  ...
  // WooCommerce Sessions (for cart persistence)
  ...
  // WooCommerce Order Items (line items in orders)
  ...
  // WooCommerce Order Item Meta (product details, pricing, etc.)
  ...
  // WooCommerce Product Meta Lookup (for faster queries)
  ...
  // WordPress Posts table (WooCommerce stores products/orders as custom post types)
  ...
  // WordPress Post Meta (stores all product/order metadata)
  ...
  // WordPress Users (for customer data)
  ...
  // Sync mapping table (maps WolfWave IDs to WooCommerce IDs)
